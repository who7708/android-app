 ...
 * {@link androidx.core.app.FragmentPagerAdapter}, 因为它通过{@link FragmentTransaction#add(Fragment, String)},
 * {@link FragmentTransaction#attach(Fragment)}和{@link FragmentTransaction#detach(Fragment)}的方式，
 * 状态由{@link Fragment}自己维护，也不能用{@link androidx.core.app.FragmentStatePagerAdapter}, 因为
